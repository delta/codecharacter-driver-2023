...
impl Simulator {
    ...
    pub fn run_pvp(
        ...
        Command::new(
            "/home/ram/Desktop/codecharacter-2023/codecharacter-simulator-2023/build/bin/main",
        )
        .args([
            // "run",
            // &format!("--memory={}", "100m"),
        ...
        .spawn()
        .map_err(|err| {
            SimulatorError::UnidentifiedError(format!("Couldnt spawn the simulator process: {err}"))
        })
    }
